...
<div class="container higher" id="container">
    ...
    <div class="tab-content" style="background-color: #ddd;">
        ...
        <ul class="filemanager-options">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/classroom/album/upload.action?classId=${classroom.classId}&albumId=${album.albumId}"
            ...
            <li class="filter-type"><span style="font-size: 16px">${album.albumName} &nbsp; | &nbsp; <fmt:formatDate
                    value="${album.createTime}"
