...
<ul class="nav nav-pills nav-stacked nav-email ul-h">
    ...
    <li id="my-account"><a href="${pageContext.request.contextPath}/my/account.action"><i
...
<ul class="nav nav-pills nav-stacked nav-email">
    <li id="my-class"><a href="${pageContext.request.contextPath}/my/class.action"><i class="fa fa-mortar-board"></i>我的班级</a>
    </li>
    <li id="my-forum"><a href="${pageContext.request.contextPath}/my/forum.action"><i class="fa fa-group"></i>我的论坛</a>
    </li>
    <li id="my-recruit"><a href="${pageContext.request.contextPath}/my/recruit.action"><i class="fa fa-bookmark"></i>我的招聘</a>
    </li>
</ul>
