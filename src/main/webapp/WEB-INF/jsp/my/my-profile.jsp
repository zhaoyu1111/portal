                ...
                <div class="tab-pane active" id="activities">
                    <div class="activity-list">
                        ...
                        <div class="media act-media">
                            <a class="pull-left" href="#"> <img
                                    class="media-object act-thumb"
                                    src="${pageContext.request.contextPath}/assets/images/photos/userprofile.png"
                                    alt=""/>
                            </a>
                            <div class="media-body act-media-body">
                                <strong>Eileen Sideways</strong> posted a new blog. <br/>
                                <small
                                        class="text-muted">Today at 3:18pm
                                </small>

                                <div class="media blog-media">
                                    <a class="pull-left" href="#"> <img class="media-object"
                                                                        src="${pageContext.request.contextPath}/assets/images/photos/media5.png"
                                                                        alt=""/>
                                    </a>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                Sideways</strong>. <br/>
                                <small class="text-muted">2 days ago
                                    at 8:30am
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                photos</a>. <br/>
                                <small class="text-muted">5 days ago at
                                    12:30pm
                                </small>
                                ...
                                <ul class="uploadphoto-list">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/assets/images/photos/media2.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/assets/images/photos/media2.png"
                                            class="img-responsive"
                                            alt=""/></a></li>
                                    <li><a href="${pageContext.request.contextPath}/assets/images/photos/media3.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/assets/images/photos/media3.png"
                                            class="img-responsive"
                                            alt=""/></a></li>
                                </ul>
                            </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                Sideways</strong>. <br/>
                                <small class="text-muted">6 days ago
                                    at 8:15am
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <small
                                        class="text-muted">6 days ago at 6:18am
                                </small>
                                <h4 class="media-title">
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                <strong>Eileen Sideways</strong> posted a new blog. <br/>
                                <small
                                        class="text-muted">December 25 at 3:18pm
                                </small>

                                <div class="media blog-media">
                                    <a class="pull-left" href="#"> <img class="media-object"
                                                                        src="${pageContext.request.contextPath}/assets/images/photos/media4.png"
                                                                        alt=""/>
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-title">
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <small
                                        class="text-muted">December 24 at 1:30pm
                                </small>
                                <div class="mb20"></div>
                                <a href="${pageContext.request.contextPath}/assets/images/photos/media6.png"
                                   data-rel="prettyPhoto"
                                   class="img-single"><img
                                        src="${pageContext.request.contextPath}/assets/images/photos/media6.png"
                                        class="img-responsive"
                                        alt=""/></a>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                Sideways</strong>. <br/>
                                <small class="text-muted">December 15
                                    at 3:30pm
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                <strong>Eileen Sideways</strong> posted a new blog. <br/>
                                <small
                                        class="text-muted">December 15 at 3:18pm
                                </small>

                                <div class="media blog-media">
                                    <a class="pull-left" href="#"> <img class="media-object"
                                                                        src="${pageContext.request.contextPath}/assets/images/photos/media7.png"
                                                                        alt=""/>
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-title">
                    ...
                    <div class="activity-list">
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <small
                                        class="text-muted">Today at 12:30pm
                                </small>

                                <ul class="uploadphoto-list">
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media5.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/images/photos/media5.png"
                                            class="img-responsive" alt=""/></a></li>
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media4.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/images/photos/media4.png"
                                            class="img-responsive" alt=""/></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                Sin</strong>. <br/>
                                <small class="text-muted">3 days ago at
                                    1:30pm
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                <strong>Chris Anthemum</strong> liked a photos<br/>
                                <small
                                        class="text-muted">5 days ago at 12:30pm
                                </small>

                                <ul class="uploadphoto-list">
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media6.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/images/photos/media6.png"
                                            class="img-responsive" alt=""/></a></li>
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media7.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/images/photos/media7.png"
                                            class="img-responsive" alt=""/></a></li>
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media2.png"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/images/photos/media2.png"
                                            class="img-responsive" alt=""/></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                Sindilmaca</strong>. <br/>
                                <small class="text-muted">December
                                    25 at 1:30pm
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <small
                                        class="text-muted">December 23 at 3:18pm
                                </small>

                                <div class="media blog-media">
                                    <a class="pull-left" href="#"> <img class="media-object"
                                                                        src="${pageContext.request.contextPath}/images/photos/media3.png"
                                                                        alt=""/>
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-title">
