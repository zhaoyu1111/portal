                ...
                <div class="tab-pane active" id="activities">
                    <div class="activity-list">
                                ...
                                <div class="media blog-media">
                                    <a class="pull-left" href="#">
                                        <img class="media-object"
                                             src="${pageContext.request.contextPath}/images/photos/media5.png" alt=""/>
                                    </a>
                        ...
                        <div class="media act-media">
                            <a class="pull-left" href="#">
                                <img class="media-object act-thumb"
                                     src="${pageContext.request.contextPath}/images/photos/user2.png" alt=""/>
                            </a>
                            <div class="media-body act-media-body">
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <ul class="uploadphoto-list">
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media1.jpg"
                                           data-rel="prettyPhoto"><img
                                            src="${pageContext.request.contextPath}/images/photos/media1.jpg"
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media2.png"
                                           data-rel="prettyPhoto"><img
                                            ...
                                            class="img-responsive" alt=""/></a></li>
                                    <li><a href="${pageContext.request.contextPath}/images/photos/media3.png"
                                           data-rel="prettyPhoto"><img
                        ...
                        <div class="media act-media">
                            <a class="pull-left" href="#">
                                <img class="media-object act-thumb"
                                     src="${pageContext.request.contextPath}/images/photos/user4.png" alt=""/>
                            </a>
                            <div class="media-body act-media-body">
                        ...
                        <div class="media act-media">
                            <a class="pull-left" href="#">
                                <img class="media-object act-thumb"
                                     src="${pageContext.request.contextPath}/images/photos/userprofile.png" alt=""/>
                            </a>
                            <div class="media-body act-media-body">
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <div class="media blog-media">
                                    <a class="pull-left" href="#">
                                        <img class="media-object"
                                             src="${pageContext.request.contextPath}/images/photos/media4.png" alt=""/>
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-title"><a href="">Ut Enim Ad Minim Veniam</a></h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                        ...
                        <div class="media act-media">
                            ...
                            <div class="media-body act-media-body">
                                ...
                                <div class="mb20"></div>
                                <a href="${pageContext.request.contextPath}/images/photos/media6.png"
                                   data-rel="prettyPhoto" class="img-single"><img
                        ...
                        <div class="media act-media">
                            <a class="pull-left" href="#">
                                <img class="media-object act-thumb"
                                     src="${pageContext.request.contextPath}/images/photos/user5.png" alt=""/>
                            </a>
                            <div class="media-body act-media-body">
                ...
                <div class="tab-pane" id="following">
                    ...
                    <div class="activity-list">
                        ...
                        <div class="media act-media">
                            <a class="pull-left" href="#">
                                <img class="media-object act-thumb"
                                     src="${pageContext.request.contextPath}/images/photos/user1.png" alt=""/>
                            </a>
                            <div class="media-body act-media-body">
