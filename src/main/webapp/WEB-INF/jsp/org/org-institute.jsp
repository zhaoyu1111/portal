    ...
    <section>
        ...
        <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="blog-item">
                                <div class="blog-details">
                                    <h5 class="blog-title">
                                        <a href="${pageContext.request.contextPath}/orgroom.action?originId=${mass.originId}"><i
                                                class="fa fa-institution"></i> <ar:sub length="10"
                                                                                       value="${mass.originName}"/></a>
                                    </h5>
                                    <ul class="blog-meta">
                                        <li>最近活动：<fmt:formatDate value="${mass.stateTime}"
                                                                 pattern="YYYY-MM-dd"></fmt:formatDate></li>
                                        <li>成员：<a
                                                href="${pageContext.request.contextPath}/orgroom/members.action?originId=${mass.originId}">${mass.members}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="col-sm-3" id="org-outline">
                <img src="${pageContext.request.contextPath}/assets/images/icon/loading/loader.gif"
                     class="center-block">
            </div>
            <%--outline div--%>
        </div>
