...
<ul class="nav nav-tabs nav-dark">
    ...
    <li id="message-li"><a
            href="${pageContext.request.contextPath}/orgroom/message.action?originId=${orgroom.originId}">
    ...
    <li id="directory-li"><a
            href="${pageContext.request.contextPath}/orgroom/directory.action?originId=${orgroom.originId}">
        <i class="fa  fa-phone-square"></i>&nbsp;<strong>通讯录</strong></a></li>
    <li id="album-li"><a href="${pageContext.request.contextPath}/orgroom/album.action?originId=${orgroom.originId}"><i
            class="fa fa-picture-o"></i>&nbsp;<strong>相册</strong></a></li>
    <li id="dropdown-li" class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"><i
