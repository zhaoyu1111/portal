    ...
    <div class="tab-content" style="background-color: #ddd;">
        <div class="tab-pane active" id="classroom-content">
            ...
            <div class="panel panel-dark panel-alt timeline-post" id="infoBox">
                <form action="${pageContext.request.contextPath}/orgroom/publishMessage.action" method="post"
                      id="orgroomMessageForm">
                    <div class="panel-body">
                        <textarea class="form-control" placeholder="留言..." id="infoBoxText" maxlength="200"
                                  name="content"></textarea>
                    </div>
                    <div class="panel-footer" hidden="true" id="infoBoxEditor">
                        <button class="btn btn-primary pull-right" id="infoPostBtn" type="button"
                                onclick="publishMessage()">发布留言
                        </button>
                    </div>
                        ...
                        <div class="blog-item">
                            <div class="blog-details">
                                <div class="blog-summary">
                                    ...
                                    <ul class="blog-meta">
                                        <li>By: <a
                                                href="${pageContext.request.contextPath}/ta/show.action?userId=${message.userId}">${message.trueName}</a>
                                        </li>
