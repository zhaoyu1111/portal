                ...
                <div class="col-sm-9">
                    <div class="panel panel-default panel-blog">
                        <div class="panel-body">
                            ...
                            <br/>
                            <div class="blog-img"><img src="assets/images/photos/blog1.jpg" class="img-responsive"
                                                       alt=""/></div>
                            <div class="mb10"></div>
                            ${info.content} <br>
                            <div class="mb10"></div>
                    ...
                    <div class="media">
                        <a class="pull-left"
                           href="${pageContext.request.contextPath}/ta/show.action?userId=${info.userId}">
                    ...
                    <c:if test="${SESSION_USER != null}">
                        ...
                        <div class="mb20"></div>
                        <form method="post" action="${pageContext.request.contextPath}/orgroom/commentInfo.action"
                              id="form-comment">
