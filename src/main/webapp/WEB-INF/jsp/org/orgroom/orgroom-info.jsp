            ...
            <div class="panel panel-dark panel-alt timeline-post" id="infoBox">
                <form action="${pageContext.request.contextPath}/orgroom/publishInfo.action" method="post"
                    ...
                    <div class="panel-body">
                        <textarea class="form-control" placeholder="分享你的生活..." id="infoBoxText" maxlength="500"
                    ...
                    <div class="col-md-12">
                        <div class="blog-item">
                            ...
                            <c:if test="${info.infoImg!=null&&info.infoImg!=''}">
                                <a href="${pageContext.request.contextPath}/classroom/infoDetail.action?classId=${orgroom.originId}&infoId=${info.infoId}"
                                   class="blog-img" target="blank">
                            ...
                            <div class="blog-details">
                                <div class="blog-summary">
                                    ...
                                    <ul class="blog-meta">
                                        <li>By: <a
                                                href="${pageContext.request.contextPath}/ta/show.action?userId=${info.userId}">${info.trueName}</a>
                                        </li>
                                        <li><fmt:formatDate value="${info.createTime}" pattern="yyyy-MM-dd HH:mm"/></li>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/orgroom/infoDetail.action?originId=${orgroom.originId}&infoId=${info.infoId}">评论(${info.comments})</a>
                                        </li>
                                    </ul>
                                    <button class="btn btn-sm btn-white"
                                            onclick="javascript:location.href='${pageContext.request.contextPath}/orgroom/infoDetail.action?originId=${orgroom.originId}&infoId=${info.infoId}';">
                                        查看详情
                                    </button>
                                </div>
                            </div>
