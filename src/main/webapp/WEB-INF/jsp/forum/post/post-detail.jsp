            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default panel-blog">
                    <div class="panel-body">
                        ...
                        <ul class="blog-meta">
                            <li>作者: <a
                                    href="${pageContext.request.contextPath}/ta/show.action?${post.userId}">${post.trueName}</a>
                            </li>
                ...
                <c:if test="${SESSION_USER != null}">
                    ...
                    <div class="mb20"></div>
                    <form method="post" action="${pageContext.request.contextPath}/post/comment.action"
                          id="form-comment">
